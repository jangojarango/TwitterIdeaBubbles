$(function(){
	...
	function get_lighter_color(colorInHEX,lightenByASCII){ //WIP doThis
	...
	function spawn(e,word) {
		...
		$new
			...
			.text(word)
			//.css('background', '-webkit-radial-gradient(circle, '+get_lighter_color(color,'#111111')+', '+color+')')
			.css('background', '-webkit-radial-gradient(circle, #CCCCCC, '+color+')')
			.addClass('hit')
			.addClass('new')
